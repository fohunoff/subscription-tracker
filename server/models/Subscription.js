...
const subscriptionSchema = new mongoose.Schema({
  ...
  // До какого момента платежи по подписке записаны в лог. Планировщик пишет
  // событие payment на каждую наступившую дату платежа после этой отметки —
  // так история трат накапливается сама, без ручных отметок «оплачено».
  // У новой подписки ставится на момент создания: платежи, случившиеся до того,
  // как её завели в трекере, — задача разового бэкфилла, а не планировщика.
  paymentsLoggedThrough: {
    type: Date
  },
  archivedAt: {
    type: Date
